...
ActiveRecord::Schema[8.0].define(version: 2026_02_27_171000) do
  ...
  create_table "bundles", force: :cascade do |t|
    ...
    t.index ["deleted"], name: "index_bundles_on_deleted"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["rank_position"], name: "index_users_on_rank_position"
    t.index ["ranking_score"], name: "index_users_on_ranking_score"
  end
